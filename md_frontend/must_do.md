...
| F8 | 지도: 경로 자료가 없는 동안 정거장 점만 표시(**직선 연결도 하지 않음**, 2026-09-18 지시). 지도 실패 시 정거장 목록으로 진행. **정거장 좌표는 현재 0/22 등록** — 좌표 없는 정거장은 마커를 만들지 않고 목록으로 제공하며, `verification_status`로 확정·확인 필요를 구분 | ../md/10-stop-discovery.md 2·3장 |
