...
| S3 | **입력자·관리자 로그인 방식 확정** — 현재는 아이디·비밀번호 + 24시간 토큰 | 사용자 고민 중. 학생은 로그인 없음(현행 유지). 기록·관리 쪽 대안: 초대 링크·접속 코드, 토큰 수명 연장. **개발용 임시 계정 `admin/admin`·`user/1234`(2026-09-18)를 공개 전에 지우거나 재설정한다** | ../md/01-conventions.md 5장, ../README.md |
